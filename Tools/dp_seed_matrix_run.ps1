...
# 2026-07-01: config names gained the render-backend prefix (Vulkan_/D3D12_/Null_).
# Headless is now the Null_ backend (there is no --headless flag), so the
# headless cells point at the null output dir.
