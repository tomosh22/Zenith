...
//
// Cross-subsystem dependencies (FluxGraphics / HDR / ParticleGPU / Frame /
// VulkanMemory) are reached via g_xEngine at point of use. The non-capturing
...
// via g_xEngine.Particles() to reach this singleton instance.
