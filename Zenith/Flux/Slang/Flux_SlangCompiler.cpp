...
//     stage mask, parameter-block path, reflected CB fields). The legacy
//     BindingType field and the v1/v2 fallbacks were removed with the binding-
//     model overhaul; the reader accepts ONLY v3 and fails loudly otherwise
//     (every sidecar is regenerated by FluxCompiler in lockstep).
static constexpr u_int32 kFluxReflectionMagic   = 0x46525846; // 'FXRF'
static constexpr u_int32 kFluxReflectionVersion = 3;
