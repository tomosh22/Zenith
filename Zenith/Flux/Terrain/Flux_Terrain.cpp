...
void Flux_Terrain::Render()
{
	...
	std::vector<Zenith_TerrainComponent*> xModels;
	Zenith_Scene::GetCurrentScene().GetAllOfComponentType<Zenith_TerrainComponent>(xModels);
	...
	for (Zenith_TerrainComponent* pxModel : xModels)
	{
		...
		Flux_Material& xMaterial0 = pxModel->GetMaterial0();
		Flux_Material& xMaterial1 = pxModel->GetMaterial1();
