...
// Shader programs owned by the LightClustering render feature. Pure data: this header
...
namespace Flux_LightClusteringShaders
{
	inline constexpr Flux_ShaderDecl xLightClustering{ "LightClustering", "DynamicLights/Flux_LightClustering", nullptr, nullptr, "csMain", "spirv_1_3", "DynamicLights" };
