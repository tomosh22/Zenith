...
namespace Flux_Generated_IBL
{
	...
	namespace IBL_IrradianceConvolution
	{
		...
		inline constexpr unsigned int kIrradianceConstants_Set = 0;
		inline constexpr unsigned int kIrradianceConstants_Binding = 1;
		...
		inline constexpr unsigned int kg_xSkyboxCubemap_Set = 0;
		inline constexpr unsigned int kg_xSkyboxCubemap_Binding = 2;
	...
	namespace IBL_PrefilterEnvMap
	{
		...
		inline constexpr unsigned int kPrefilterConstants_Set = 0;
		inline constexpr unsigned int kPrefilterConstants_Binding = 1;
