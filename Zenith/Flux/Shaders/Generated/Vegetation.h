...
namespace Flux_Generated_Vegetation
{
	...
	namespace Grass
	{
		...
		inline constexpr const char* kGrassConstants_Name = "GrassConstants";
		inline constexpr unsigned int kGrassConstants_Set = 3;
		inline constexpr unsigned int kGrassConstants_Binding = 0;
		inline constexpr unsigned int kGrassConstants_DescriptorCount = 1;
		// kind: ConstantBuffer
		...
		inline constexpr unsigned int kInstanceBuffer_Binding = 1;
