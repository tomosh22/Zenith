...
namespace Flux_Generated_Vegetation
{
	...
	namespace Grass
	{
		...
		inline constexpr unsigned int kGrassConstants_Set = 0;
		inline constexpr unsigned int kGrassConstants_Binding = 1;
		...
		inline constexpr unsigned int kInstanceBuffer_Binding = 2;
