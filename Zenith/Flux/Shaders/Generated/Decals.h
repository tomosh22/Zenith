...
namespace Flux_Generated_Decals
{
	...
	namespace Decals_NormalsCopy
	{
		...
		inline constexpr Flux_BindingHandle hg_xNormalsTex{ 3u, 0u, FLUX_RESOURCE_KIND_COMBINED_TEXTURE_SAMPLER, 1u };
	}
	...
	namespace Decals_Apply
	{
		...
		inline constexpr unsigned int kg_xDepthTex_Binding = 0;
		inline constexpr unsigned int kg_xDepthTex_DescriptorCount = 1;
		// kind: CombinedTextureSampler
		inline constexpr Flux_BindingHandle hg_xDepthTex{ 3u, 0u, FLUX_RESOURCE_KIND_COMBINED_TEXTURE_SAMPLER, 1u };
		inline constexpr const char* kg_xNormalsCopyTex_Name = "g_xNormalsCopyTex";
		inline constexpr unsigned int kg_xNormalsCopyTex_Set = 3;
		inline constexpr unsigned int kg_xNormalsCopyTex_Binding = 1;
		inline constexpr unsigned int kg_xNormalsCopyTex_DescriptorCount = 1;
		// kind: CombinedTextureSampler
		inline constexpr Flux_BindingHandle hg_xNormalsCopyTex{ 3u, 1u, FLUX_RESOURCE_KIND_COMBINED_TEXTURE_SAMPLER, 1u };
		inline constexpr const char* kDecalBuffer_Name = "DecalBuffer";
		inline constexpr unsigned int kDecalBuffer_Set = 3;
		inline constexpr unsigned int kDecalBuffer_Binding = 2;
