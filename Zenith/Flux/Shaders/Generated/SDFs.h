...
namespace Flux_Generated_SDFs
{
	...
	namespace SDFs
	{
		...
		inline constexpr unsigned int kSphereData_Set = 3;
		inline constexpr unsigned int kSphereData_Binding = 0;
		inline constexpr unsigned int kSphereData_DescriptorCount = 1;
		// kind: ConstantBuffer
		inline constexpr Flux_BindingHandle hSphereData{ 3u, 0u, FLUX_RESOURCE_KIND_CONSTANT_BUFFER, 1u };
