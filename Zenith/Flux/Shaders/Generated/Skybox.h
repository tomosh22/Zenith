...
namespace Flux_Generated_Skybox
{
	...
	namespace SkyboxAtmosphere
	{
		...
		struct AtmosphereConstants_CB
		{
			...
			float m_fg_fAerialStrength; // slang=float offset=56
			unsigned int m_ug_uDebugMode; // slang=uint offset=60
			unsigned int m_ug_uSkySamples; // slang=uint offset=64
			unsigned int m_ug_uLightSamples; // slang=uint offset=68
		...
		static_assert(offsetof(AtmosphereConstants_CB, m_fg_fAerialStrength) == 56, "AtmosphereConstants.g_fAerialStrength offset drifted from Slang reflection");
		static_assert(offsetof(AtmosphereConstants_CB, m_ug_uDebugMode) == 60, "AtmosphereConstants.g_uDebugMode offset drifted from Slang reflection");
		static_assert(offsetof(AtmosphereConstants_CB, m_ug_uSkySamples) == 64, "AtmosphereConstants.g_uSkySamples offset drifted from Slang reflection");
		static_assert(offsetof(AtmosphereConstants_CB, m_ug_uLightSamples) == 68, "AtmosphereConstants.g_uLightSamples offset drifted from Slang reflection");
		inline constexpr const char* kFrameConstants_Name = "FrameConstants";
		inline constexpr unsigned int kFrameConstants_Set = 0;
		inline constexpr unsigned int kFrameConstants_Binding = 0;
		inline constexpr unsigned int kFrameConstants_DescriptorCount = 1;
	...
	// ----- SkyboxAerialPerspective (Skybox/Flux_AerialPerspective) -----
	namespace SkyboxAerialPerspective
	{
		inline constexpr const char* kAtmosphereConstants_Name = "AtmosphereConstants";
		inline constexpr unsigned int kAtmosphereConstants_Set = 0;
		inline constexpr unsigned int kAtmosphereConstants_Binding = 1;
