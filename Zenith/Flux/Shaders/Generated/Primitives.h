...
namespace Flux_Generated_Primitives
{
	// ----- Primitives (Primitives/Flux_Primitives) -----
	namespace Primitives
	{
		...
		inline constexpr const char* kPrimitivePushConstant_Name = "PrimitivePushConstant";
		inline constexpr unsigned int kPrimitivePushConstant_Set = 3;
		inline constexpr unsigned int kPrimitivePushConstant_Binding = 0;
		inline constexpr unsigned int kPrimitivePushConstant_DescriptorCount = 1;
		// kind: ConstantBuffer
		inline constexpr Flux_BindingHandle hPrimitivePushConstant{ 3u, 0u, FLUX_RESOURCE_KIND_CONSTANT_BUFFER, 1u };
		struct PrimitivePushConstant_CB
		{
