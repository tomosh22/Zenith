...
namespace Flux_Generated_Gizmos
{
	...
	namespace Gizmos
	{
		...
		inline constexpr unsigned int kGizmoPushConstants_Set = 3;
		inline constexpr unsigned int kGizmoPushConstants_Binding = 0;
		inline constexpr unsigned int kGizmoPushConstants_DescriptorCount = 1;
		// kind: ConstantBuffer
		inline constexpr Flux_BindingHandle hGizmoPushConstants{ 3u, 0u, FLUX_RESOURCE_KIND_CONSTANT_BUFFER, 1u };
