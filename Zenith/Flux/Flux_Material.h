...
public:
	Flux_Material()
		: m_pxDiffuse(Flux_Graphics::s_pxBlankTexture2D)
		, m_pxNormal(Flux_Graphics::s_pxBlankTexture2D)
		, m_pxRoughness(Flux_Graphics::s_pxBlankTexture2D)
		, m_pxMetallic(Flux_Graphics::s_pxBlankTexture2D)
	{
	}
	...
	Flux_Texture* GetDiffuse() const { return m_pxDiffuse ? m_pxDiffuse : Flux_Graphics::s_pxBlankTexture2D; }
	Flux_Texture* GetNormal() const { return m_pxNormal ? m_pxNormal : Flux_Graphics::s_pxBlankTexture2D; }
	Flux_Texture* GetRoughness() const { return m_pxRoughness ? m_pxRoughness : Flux_Graphics::s_pxBlankTexture2D; }
	Flux_Texture* GetMetallic() const { return m_pxMetallic ? m_pxMetallic : Flux_Graphics::s_pxBlankTexture2D; }
