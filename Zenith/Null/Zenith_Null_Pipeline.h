...
// ============================================================================
// NO-OP "null" render backend — Pipeline family.
//
// Mirrors the neutral public surface of Zenith_Vulkan_Pipeline.h. Six classes:
//   Zenith_Null_Shader                  (concept FluxBackendShader)
//   Zenith_Null_RootSig                 (alias-only, no concept)
//   Zenith_Null_Pipeline                (alias-only, no concept)
//   Zenith_Null_RootSigBuilder          (concept FluxBackendRootSigBuilder)
//   Zenith_Null_PipelineBuilder         (concept FluxBackendPipelineBuilder)
//   Zenith_Null_ComputePipelineBuilder  (concept FluxBackendComputePipelineBuilder)
//
...
//
// The single exception to "pure no-op" is Zenith_Null_Shader::Initialise,
...
//==========================================================================
// Zenith_Null_Shader  (satisfies FluxBackendShader)
//==========================================================================
class Zenith_Null_Shader
{
public:
	Zenith_Null_Shader() = default;
	~Zenith_Null_Shader() { }
...
//==========================================================================
// Zenith_Null_RootSig  (alias-only — no concept; builders populate it)
//==========================================================================
...
//==========================================================================
// Zenith_Null_Pipeline  (alias-only — no concept; builders produce it)
//==========================================================================
class Zenith_Null_Pipeline
{
public:
	Zenith_Null_Pipeline() = default;
	~Zenith_Null_Pipeline() { }
	...
	Zenith_Null_RootSig m_xRootSig;
};

//==========================================================================
// Zenith_Null_RootSigBuilder  (satisfies FluxBackendRootSigBuilder)
//==========================================================================
class Zenith_Null_RootSigBuilder
{
public:
	// Build from manual specification.
	static void FromSpecification(Zenith_Null_RootSig& /*xRootSigOut*/, const Flux_PipelineLayout& /*xSpec*/) { }
	...
	static void FromReflection(Zenith_Null_RootSig& xRootSigOut, const Flux_ShaderReflection& xReflection)
	{
...
//==========================================================================
// Zenith_Null_PipelineBuilder  (satisfies FluxBackendPipelineBuilder)
//
...
{
public:
	Zenith_Null_PipelineBuilder() { }
	~Zenith_Null_PipelineBuilder() { }

	// Neutral fluent setter (param type is the backend Shader alias).
	Zenith_Null_PipelineBuilder& WithShader(const Zenith_Null_Shader& /*xShader*/) { return *this; }

	Zenith_Null_PipelineBuilder& WithTesselation() { return *this; }

	// Concept entry point: compile a complete graphics pipeline from the spec.
	//
	// VALIDATE-ONLY. There is no GPU pipeline to build, but the vertex-layout
	// cross-check still runs — and it is worth MORE here than on Vulkan-Windows:
	// this backend loads the COMMITTED .spv.refl sidecars, so the comparison is
	// "committed sidecar vs committed Generated/ header", which is exactly the
	// drift a headless CI leg can catch without a GPU.
	static void FromSpecification(Zenith_Null_Pipeline& /*xPipelineOut*/, const Flux_PipelineSpecification& xSpec)
	{
...
//==========================================================================
// Zenith_Null_ComputePipelineBuilder  (satisfies FluxBackendComputePipelineBuilder)
//==========================================================================
class Zenith_Null_ComputePipelineBuilder
{
public:
	Zenith_Null_ComputePipelineBuilder() { }

	// Neutral fluent setter (param type is the backend Shader alias).
	Zenith_Null_ComputePipelineBuilder& WithShader(const Zenith_Null_Shader& /*xShader*/) { return *this; }
	...
	Zenith_Null_ComputePipelineBuilder& WithLayout(u_int /*uLayout*/) { return *this; }

	void Build(Zenith_Null_Pipeline& /*xPipelineOut*/) { }

	// Concept entry point: one-call WithShader + WithLayout + Build + root-sig assign.
	static void BuildFromShader(Zenith_Null_Pipeline& /*xPipelineOut*/,
	                            const Zenith_Null_Shader& /*xShader*/,
	                            const Zenith_Null_RootSig& /*xRootSig*/) { }

private:
	const Zenith_Null_Shader* m_pxShader = nullptr;
};
