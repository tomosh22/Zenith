...
// ============================================================================
// NO-OP null backend: swapchain / presentation.
//
...
{
public:
	Zenith_Null_Swapchain() {}
	~Zenith_Null_Swapchain() {}
	Zenith_Null_Swapchain(const Zenith_Null_Swapchain&) = delete;
	Zenith_Null_Swapchain& operator=(const Zenith_Null_Swapchain&) = delete;
