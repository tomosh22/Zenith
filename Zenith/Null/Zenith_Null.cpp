...
#include "Null/Zenith_Null.h"
#include "Null/Zenith_Null_CommandBuffer.h"
...
// which the seam-reachable Zenith_Null.h header is kept clear of. See the
// declaration's comment in Zenith_Null.h.
void Zenith_Null::RecordFrame(const Flux_WorkDistribution& xWorkDistribution)
{
	...
	Zenith_Null_CommandBuffer xNoOpCmdBuf;
...
void Zenith_Null::InitialiseImGui()
{
...
void Zenith_Null::ImGuiBeginFrame()
{
...
void Zenith_Null::ShutdownImGui()
{
...
u_int64 Zenith_Null::GetImGuiMemoryAllocated()
{
	return s_ulImGuiMemoryAllocated.load();
}

u_int64 Zenith_Null::GetImGuiAllocationCount()
{
