...
// loaded scene by Zenith_EntityID. Engine owns this storage now as
// m_pxEntityStore; Zenith_SceneData keeps using-aliases for back-compat so
// the qualified type names (Zenith_SceneData::Zenith_EntitySlot etc.) keep
// resolving.
