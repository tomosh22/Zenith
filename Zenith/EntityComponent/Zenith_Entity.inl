...
T& Zenith_Entity::AddComponent(Args&&... args)
{
	...
	Zenith_Assert(!pxSceneData->IsUnloading(), "AddComponent: Cannot add component during scene unload");
...
void Zenith_Entity::RemoveComponent()
{
	...
	Zenith_Assert(pxSceneData->IsLoaded() || pxSceneData->IsUnloading(), "RemoveComponent: Entity's scene is not loaded");
