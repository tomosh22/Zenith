...
// ============================================================================
// ResolveAssetsDir tests (--assets-root relocatable-package override)
//
// Pure function: no engine state touched, so no save/restore needed. Covers
// the two contract halves: no/empty override => the baked dir passes through
// UNCHANGED (including the deliberately-empty "" that FluxCompiler / hub /
// Android bake), and an override => "<root>/<rel>" with trailing root
// separators trimmed (run.bat passes "%~dp0", which ends in a backslash).
// ============================================================================

ZENITH_TEST(AssetRegistry, ResolveAssetsDirNullOverride) { Zenith_UnitTests::TestAssetRegistryResolveAssetsDirNullOverride(); }
void Zenith_UnitTests::TestAssetRegistryResolveAssetsDirNullOverride()
{
	const std::string strResolved = Zenith_AssetRegistry::ResolveAssetsDir("C:/dev/Zenith/Games/Sokoban/Assets/", nullptr, "Games/Sokoban/Assets/");
...
ZENITH_TEST(AssetRegistry, ResolveAssetsDirEmptyOverride) { Zenith_UnitTests::TestAssetRegistryResolveAssetsDirEmptyOverride(); }
void Zenith_UnitTests::TestAssetRegistryResolveAssetsDirEmptyOverride()
{
	const std::string strResolved = Zenith_AssetRegistry::ResolveAssetsDir("C:/baked/Assets/", "", "Games/X/Assets/");
	ZENITH_ASSERT_EQ(strResolved, std::string("C:/baked/Assets/"),
		"empty override must pass the baked dir through unchanged");
}

ZENITH_TEST(AssetRegistry, ResolveAssetsDirJoinsUnderRoot) { Zenith_UnitTests::TestAssetRegistryResolveAssetsDirJoinsUnderRoot(); }
void Zenith_UnitTests::TestAssetRegistryResolveAssetsDirJoinsUnderRoot()
{
	const std::string strResolved = Zenith_AssetRegistry::ResolveAssetsDir("C:/baked/Assets/", "D:/pkg", "Games/Sokoban/Assets/");
...
ZENITH_TEST(AssetRegistry, ResolveAssetsDirTrimsRootSeparators) { Zenith_UnitTests::TestAssetRegistryResolveAssetsDirTrimsRootSeparators(); }
void Zenith_UnitTests::TestAssetRegistryResolveAssetsDirTrimsRootSeparators()
{
	const std::string strResolved = Zenith_AssetRegistry::ResolveAssetsDir("C:/baked/", "D:\\pkg\\", "Zenith/Assets/");
...
ZENITH_TEST(AssetRegistry, ResolveAssetsDirEmptyBakedPassthrough) { Zenith_UnitTests::TestAssetRegistryResolveAssetsDirEmptyBakedPassthrough(); }
void Zenith_UnitTests::TestAssetRegistryResolveAssetsDirEmptyBakedPassthrough()
{
	const std::string strResolved = Zenith_AssetRegistry::ResolveAssetsDir("", nullptr, "Games/X/Assets/");
