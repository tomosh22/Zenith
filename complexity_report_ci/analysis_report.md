...
- Include edges resolved: 2691 relative-path + 0 unique-basename (high confidence, gated); 2 ambiguous-basename (low confidence, suppressed from gates); 2 basename total (0%)
- External includes (middleware/third-party): 116
- Include redundancy: score **256** (52 duplicate, 204 transitive, 0 unresolved, 0 conflicting)
...
- **max-forbidden-tokens: 4** — e.g. `token:Zenith/AssetHandling/Zenith_FontAsset.cpp => std::vector`
...
| Profiling | 0 | 2 | 9 | 3 | 0.25 | 0.00 | 0.75 | - |
...
| AssetHandling | 2 | 32 | 6 | 7 | 0.54 | 0.00 | 0.46 | - |
| EntityComponent | 2 | 48 | 3 | 16 | 0.84 | 0.00 | 0.16 | main-sequence |
| Flux | 2 | 186 | 8 | 11 | 0.58 | 0.01 | 0.41 | - |
| Physics | 2 | 6 | 4 | 4 | 0.50 | 0.00 | 0.50 | - |
...
| Editor | 4 | 54 | 3 | 17 | 0.85 | 0.04 | 0.10 | main-sequence |
...
- Files: **578**, SLOC: **97,365**, Functions: **6,101**, Classes: **1,474**
- Avg Cyclomatic: **18.2** (max 249), Avg Cognitive: **22.8** (max 475)
- Priority score distribution: **20** high (>=70, 3.5%), **144** medium, **414** low. P50=10.3, P90=65.8.
...
### 2. `Zenith\Editor\TerrainEditor\Zenith_TerrainEditor.cpp:419` — `Zenith_TerrainEditor::HandleViewportInput` (score: 70.5)
Dominant signal: **cognitive**
...
### 4. `Zenith\Flux\MeshAnimation\Flux_InverseKinematics.cpp:300` — `Flux_IKSolver::SolveChain` (score: 69.8)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 9. `Zenith\Flux\MeshAnimation\Flux_InverseKinematics.cpp:635` — `Flux_IKSolver::ConvertPositionsToRotations` (score: 60.0)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 10. `Zenith\Core\Zenith_AutomatedTest.cpp:190` — `Zenith_AutomatedTestRunner::ParseCommandLine` (score: 59.3)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 11. `Zenith\Editor\TerrainEditor\Zenith_TerrainEditor_Brushes.cpp:82` — `Zenith_TerrainEditor::ApplyHeightDab` (score: 57.9)
Dominant signal: **cyclomatic**
Tags: `long-function`, `complex-branching`, `many-params`
...
### 12. `Zenith\Editor\Panels\Zenith_EditorPanel_TerrainEditor.cpp:49` — `RenderBrushSection` (score: 57.6)
Dominant signal: **cyclomatic**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 13. `Zenith\Telemetry\Zenith_Telemetry.cpp:459` — `Reader::ExportJson` (score: 57.5)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 14. `Zenith\Editor\TerrainEditor\Zenith_TerrainEditor_Trees.cpp:112` — `Zenith_TerrainEditor::ApplyTreeDab` (score: 55.2)
Dominant signal: **cognitive**
...
### 15. `Zenith\Editor\TerrainEditor\Zenith_TerrainEditor.cpp:703` — `Zenith_TerrainEditor::RaycastHeightfield` (score: 53.5)
Dominant signal: **cognitive**
...
### 19. `Zenith\Flux\RenderGraph\Flux_RenderGraph_Compilation.cpp:748` — `Flux_RenderGraph::SynthesizeAliasingBarriers` (score: 51.2)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`, `hard-to-follow`
...
### 20. `Zenith\AI\Navigation\Zenith_NavMeshAgent.cpp:103` — `Zenith_NavMeshAgent::Update` (score: 51.0)
Dominant signal: **cognitive**
Tags: `long-function`, `complex-branching`
CC=16, cognitive=23, nesting=3, LOC=139, params=2, returns=4
Score breakdown: cognitive=34%, cyclomatic=26%, length=20%, nesting=15%, params=5%
...
| `Zenith\Physics\Zenith_Physics.cpp` | `low-mi`, `god-file` | 70.0 | 88 | 137 | 4 | 644 | 51 |
...
| `Zenith\AI\Navigation\Zenith_NavMeshAgent.cpp` | `low-mi` | 69.5 | 45 | 70 | 3 | 276 | 11 |
| `Zenith\AssetHandling\Zenith_MaterialAsset.cpp` | `low-mi` | 69.5 | 52 | 72 | 3 | 437 | 22 |
| `Zenith\Editor\Panels\Zenith_EditorPanel_Hierarchy.cpp` | `low-mi` | 69.5 | 96 | 146 | 4 | 536 | 19 |
...
| `Flux_RenderGraph` | `Zenith\Flux\RenderGraph\Flux_RenderGraph.h:196` | 0.98 | 7 | 36 |
| `Zenith_SceneSystem` | `Zenith\ZenithECS\Zenith_SceneSystem.h:74` | 0.97 | 11 | 30 |
...
| --- | ---: | ---: | :---: |
| `Zenith\Core\Zenith.h` | 266 | 12 |  |
| `Zenith\Core\Zenith_Engine.h` | 138 | 1 |  |
| `Zenith\Maths\Zenith_Maths.h` | 79 | 0 |  |
| `Zenith\Collections\Zenith_Vector.h` | 77 | 3 |  |
...
| `Zenith\Flux\Flux_GraphicsImpl.h` | 60 | 4 |  |
| `Zenith\ZenithECS\Zenith_SceneSystem.h` | 52 | 7 |  |
| `Zenith\DebugVariables\Zenith_DebugVariables.h` | 47 | 3 |  |
| `Zenith\ZenithECS\Zenith_Entity.h` | 41 | 1 |  |
| `Zenith\Flux\Flux_Buffers.h` | 38 | 2 |  |
| `Zenith\Flux\RenderGraph\Flux_RenderGraph.h` | 36 | 5 |  |
| `Zenith\ZenithECS\Zenith_Scene.h` | 36 | 0 |  |
...
### Transitively-covered includes (204 total)
...
## External includes (116 resolved to 35 middleware/third-party header(s))
...
| `Zenith\Core` | 40 | 3,677 | 73.6 | 3.0 | 10.3 | `Zenith\Core\Zenith_AutomatedTest.cpp` |
| `Zenith\Telemetry` | 2 | 746 | 73.2 | 41.7 | 37.0 | `Zenith\Telemetry\Zenith_Telemetry.cpp` |
| `Zenith\Flux\RenderGraph` | 5 | 2,399 | 73.1 | 62.6 | 97.6 | `Zenith\Flux\RenderGraph\Flux_RenderGraph_Compilation.cpp` |
| `Zenith\UI` | 25 | 4,078 | 72.7 | 13.7 | 22.0 | `Zenith\UI\Zenith_UIText.cpp` |
| `Zenith\Vulkan` | 25 | 6,342 | 72.4 | 17.4 | 24.5 | `Zenith\Vulkan\Zenith_Vulkan_CommandBuffer.cpp` |
| `Zenith\Editor\Panels` | 24 | 4,857 | 71.5 | 13.0 | 34.5 | `Zenith\Editor\Panels\Zenith_EditorPanel_Memory.cpp` |
| `Zenith\EntityComponent\Components` | 30 | 6,871 | 70.3 | 31.5 | 26.0 | `Zenith\EntityComponent\Components\Zenith_InstancedMeshComponent.cpp` |
| `Zenith\Flux\Terrain` | 6 | 1,590 | 70.1 | 9.8 | 30.7 | `Zenith\Flux\Terrain\Flux_TerrainStreamingManager.cpp` |
| `Zenith\Physics` | 5 | 1,409 | 70.0 | 8.5 | 33.6 | `Zenith\Physics\Zenith_Physics.cpp` |
| `Zenith\AssetHandling` | 32 | 5,283 | 69.5 | 13.6 | 17.7 | `Zenith\AssetHandling\Zenith_MaterialAsset.cpp` |
| `Zenith\Flux\MeshGeometry` | 4 | 1,293 | 69.5 | 50.1 | 36.8 | `Zenith\Flux\MeshGeometry\Flux_MeshGeometry.cpp` |
