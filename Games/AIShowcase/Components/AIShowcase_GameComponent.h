...
/**
 * AIShowcase_GameComponent.h - Main AI demonstration coordinator
 *
...
// ============================================================================
class AIShowcase_GameComponent
{
public:
	AIShowcase_GameComponent() = delete;
	AIShowcase_GameComponent(Zenith_Entity& xParentEntity)
		: m_xPlayerPos(0.0f)
		, m_fPlayerYaw(0.0f)
	...
	~AIShowcase_GameComponent() = default;

	// Component pools move-construct on resize; the user-declared destructor
	// suppresses the implicit moves, so restore them explicitly.
	AIShowcase_GameComponent(AIShowcase_GameComponent&&) = default;
	AIShowcase_GameComponent& operator=(AIShowcase_GameComponent&&) = default;
	AIShowcase_GameComponent(const AIShowcase_GameComponent&) = delete;
	AIShowcase_GameComponent& operator=(const AIShowcase_GameComponent&) = delete;
	...
	// ========================================================================
	// Serialization (required by the component contract; no persisted state -
	// the old behaviour serialized no parameters either)
	// ========================================================================
