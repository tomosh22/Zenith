...
Components/
  ...
  DPInteractable_Base.h            # Distance-based proximity + F-press → DP_OnInteract (plain base class, NOT a registered component)
    DPDoor_Component.h               # Lerp-rotate, key-gated
    DPDoubleDoor_Component.h         # Two-leaf door; FindChildTransform("Leaf_L"/"Leaf_R") drives rotation
    DPChest_Component.h              # Lid pivot (loot dispense WIP)
    DPForge_Component.h              # Recipe Iron→Key: consume input entity + spawn output + auto-equip
    DPPentagram_Component.h          # Win condition: collect 5 objectives
    DummyNoiseMachine_Component.h    # Emit sound stimulus on interact
...
Tests/                                 # 117 registered tests as of 2026-05-20 (104 .cpp files)
