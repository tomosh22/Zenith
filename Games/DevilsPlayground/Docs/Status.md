...
**Last updated:** 2026-05-13 — Q-2026-05-12-007 **partially** resolved (engine `--headless` mode shipped + verified locally); MVP-0.0.3 reactivated but dp-tests **remains informational, NOT required**, pending CI asset-provisioning.
