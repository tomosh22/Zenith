...
// world entities that don't carry their own DPInteractable_Base.
// ============================================================================
namespace DP_Interactables
{
	...
	// Moved here from DPHUDController_Component so the HUD header no longer
	// includes the interactable behaviour headers (cross-component rule).
