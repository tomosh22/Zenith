...
/**
 * DPDoubleDoor_Component - same lock semantics as DPDoor, but rotates two
...
class DPDoubleDoor_Component ZENITH_FINAL : public DPInteractable_Base
{
public:
	DPDoubleDoor_Component() = delete;
	DPDoubleDoor_Component(Zenith_Entity& xParentEntity)
...
protected:
	void HandleInteract(Zenith_EntityID xVillager) override
	{
		...
		// DPDoor_Component -- analyzer / visualiser don't distinguish
