 ...
 * the orbit math is implemented as a script behaviour on the camera entity.
 */
...
class DPOrbitCamera_Behaviour ZENITH_FINAL : Zenith_ScriptBehaviour
{
	friend class Zenith_ScriptComponent;
public:
	ZENITH_BEHAVIOUR_TYPE_NAME(DPOrbitCamera_Behaviour)

	DPOrbitCamera_Behaviour() = delete;
	DPOrbitCamera_Behaviour(Zenith_Entity& /*xParentEntity*/)
	{}
