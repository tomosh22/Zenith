"""Seeded soft smoke billboard, authored for Flux GPU particle alpha blending."""
from pathlib import Path
import bpy, numpy as np
out=Path(__file__).resolve().parents[1]/'Assets/Textures/Particles/Smoke.png'
...
im=bpy.data.images.new('Foundry soft exhaust',width=n,height=n,alpha=True)
im.pixels.foreach_set(rgba.ravel());im.filepath_raw=str(out);im.file_format='PNG';im.save()
print('FOUNDRY_SMOKE_TEXTURE',out)
