...
namespace
{
	...
	void ZM_BipedBuildIdle(Flux_AnimationClip& xOut)
	{
		...
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_SPINE[1], fClipSeconds, uKeys, [](float fT)
		{
			const float fP = fT * fZM_BIPED_TWO_PI;
			return ZM_AnimRotCompose(ZM_AnimRotZ(2.0f * sinf(fP)), ZM_AnimRotX(1.2f * sinf(fP + 0.4f)));
		});
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_SPINE[2], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotZ(-1.5f * sinf(fT * fZM_BIPED_TWO_PI));
		});
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_SPINE[3], fClipSeconds, uKeys, [](float fT)
		{
			const float fP = fT * fZM_BIPED_TWO_PI;
		...
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_HEAD, fClipSeconds, uKeys, [](float fT)
		{
			const float fP = fT * fZM_BIPED_TWO_PI;
		...
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_ARM_UP[0], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotX(2.0f * sinf(fT * fZM_BIPED_TWO_PI));
		});
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_ARM_UP[1], fClipSeconds, uKeys, [](float fT)
		{
	...
	void ZM_BipedBuildWalk(Flux_AnimationClip& xOut)
	{
		...
		for (u_int l = 0; l < 2u; ++l)
		{
			...
			ZM_AnimAddRotCurve(xOut, szZM_BIPED_LEG_UP[l], fClipSeconds, uKeys, [fPh](float fT)
			{
				return ZM_AnimRotX(fZM_BIPED_WALK_HIP_SWING * sinf(fT * fZM_BIPED_TWO_PI + fPh));
			});
			ZM_AnimAddRotCurve(xOut, szZM_BIPED_LEG_LO[l], fClipSeconds, uKeys, [fPh, fKneeLag](float fT)
			{
		...
		for (u_int a = 0; a < 2u; ++a)
		{
			...
			ZM_AnimAddRotCurve(xOut, szZM_BIPED_ARM_UP[a], fClipSeconds, uKeys, [fPh](float fT)
			{
				return ZM_AnimRotX(fZM_BIPED_WALK_ARM_SWING * sinf(fT * fZM_BIPED_TWO_PI + fPh));
			});
			ZM_AnimAddRotCurve(xOut, szZM_BIPED_ARM_LO[a], fClipSeconds, uKeys, [fPh, fElbowLag](float fT)
			{
		...
		ZM_AnimAddRotCurve(xOut, szZM_BIPED_SPINE[0], fClipSeconds, uKeys, [](float fT)
		{
	...
	void ZM_BipedBuildAttack(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axSpine01[] = {
			...
			{ ZM_AnimTimeForT01(0.50f, fD), ZM_AnimRotX(14.0f)  },   // thrust forward
			{ ZM_AnimTimeForT01(0.72f, fD), ZM_AnimRotX(6.0f)   },   // follow-through
		...
		const ZM_AnimRotKey axSpine03[] = {
			...
			{ ZM_AnimTimeForT01(0.50f, fD), ZM_AnimRotX(18.0f)  },
			{ ZM_AnimTimeForT01(0.72f, fD), ZM_AnimRotX(7.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axHead[] = {
			...
			{ ZM_AnimTimeForT01(0.50f, fD), ZM_AnimRotX(16.0f)  },
		...
		const ZM_AnimRotKey axArmUp[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.18f, fD), ZM_AnimRotX(-35.0f) },   // windup (arm back/up)
			{ ZM_AnimTimeForT01(0.45f, fD), ZM_AnimRotX(55.0f)  },   // strike forward
			{ ZM_AnimTimeForT01(0.70f, fD), ZM_AnimRotX(20.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axArmLo[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.18f, fD), ZM_AnimRotX(-20.0f) },
			{ ZM_AnimTimeForT01(0.45f, fD), ZM_AnimRotX(30.0f)  },
	...
	void ZM_BipedBuildSpecial(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axSpine01[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-18.0f) },   // lean back
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-20.0f) },   // charged hold
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(14.0f)  },   // release forward
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_BIPED_SPINE[1], axSpine01, 5u);
		...
		const ZM_AnimRotKey axSpine02[] = {
			...
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(12.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axSpine03[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-22.0f) },
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-24.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(16.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_BIPED_SPINE[3], axSpine03, 5u);
		...
		const ZM_AnimRotKey axHead[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-26.0f) },   // head raise
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-28.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(10.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_BIPED_HEAD, axHead, 5u);
		...
		const ZM_AnimRotKey axArmUp[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(85.0f)  },   // raised (charge)
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(90.0f)  },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(45.0f)  },   // thrust forward
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axArmLo[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-25.0f) },   // elbows cocked
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-28.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(-10.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axCrest[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-25.0f) },   // flare back
	...
	void ZM_BipedBuildHit(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axArmFlail[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.28f, fD), ZM_AnimRotZ(22.0f) },    // flail outward
			{ ZM_AnimTimeForT01(0.60f, fD), ZM_AnimRotZ(-8.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
