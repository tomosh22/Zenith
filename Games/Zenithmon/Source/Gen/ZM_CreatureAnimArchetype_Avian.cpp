...
namespace
{
	...
	void ZM_AvianBuildIdle(Flux_AnimationClip& xOut)
	{
		...
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_SPINE[1], fClipSeconds, uKeys, [](float fT)
		{
			const float fP = fT * fZM_AVIAN_TWO_PI;
			return ZM_AnimRotCompose(ZM_AnimRotX(1.5f * sinf(fP)), ZM_AnimRotZ(1.0f * sinf(fP + 0.3f)));
		});
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_SPINE[2], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotX(1.2f * sinf(fT * fZM_AVIAN_TWO_PI + 0.5f));
		});

		// Head: shallow bob + attentive look drift.
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_HEAD, fClipSeconds, uKeys, [](float fT)
		{
			const float fP = fT * fZM_AVIAN_TWO_PI;
		...
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_WING[0], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotZ(4.0f * sinf(fT * fZM_AVIAN_TWO_PI));
		});
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_WING[1], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotZ(-4.0f * sinf(fT * fZM_AVIAN_TWO_PI));
		});

		// Tail: gentle balance sway, growing toward the tip.
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_TAIL[0], fClipSeconds, uKeys, [](float fT)
		{
			return ZM_AnimRotY(3.0f * sinf(fT * fZM_AVIAN_TWO_PI + 0.2f));
		});
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_TAIL[1], fClipSeconds, uKeys, [](float fT)
		{
	...
	void ZM_AvianBuildWalk(Flux_AnimationClip& xOut)
	{
		...
		for (u_int l = 0; l < 2u; ++l)
		{
			...
			ZM_AnimAddRotCurve(xOut, szZM_AVIAN_LEG_UP[l], fClipSeconds, uKeys, [fPh](float fT)
			{
				return ZM_AnimRotX(fZM_AVIAN_WALK_HIP_SWING * sinf(fT * fZM_AVIAN_TWO_PI + fPh));
			});
			ZM_AnimAddRotCurve(xOut, szZM_AVIAN_LEG_LO[l], fClipSeconds, uKeys, [fPh, fKneeLag](float fT)
			{
		...
		ZM_AnimAddRotCurve(xOut, szZM_AVIAN_SPINE[0], fClipSeconds, uKeys, [](float fT)
		{
	...
	void ZM_AvianBuildAttack(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axSpine02[] = {
			...
			{ ZM_AnimTimeForT01(0.18f, fD), ZM_AnimRotX(-8.0f)  },   // rear (anticipation)
			{ ZM_AnimTimeForT01(0.48f, fD), ZM_AnimRotX(16.0f)  },   // thrust forward
			{ ZM_AnimTimeForT01(0.72f, fD), ZM_AnimRotX(6.0f)   },
		...
		const ZM_AnimRotKey axHead[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.18f, fD), ZM_AnimRotX(-12.0f) },   // cock back
			{ ZM_AnimTimeForT01(0.48f, fD), ZM_AnimRotX(28.0f)  },   // peck down/forward
			{ ZM_AnimTimeForT01(0.72f, fD), ZM_AnimRotX(10.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axBeak[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.18f, fD), ZM_AnimRotX(-6.0f)  },
			{ ZM_AnimTimeForT01(0.48f, fD), ZM_AnimRotX(18.0f)  },   // jab lead
			{ ZM_AnimTimeForT01(0.72f, fD), ZM_AnimRotX(6.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axWingL[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.30f, fD), ZM_AnimRotZ(-10.0f) },   // fold in
		...
		const ZM_AnimRotKey axWingR[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.30f, fD), ZM_AnimRotZ(10.0f)  },
			{ ZM_AnimTimeForT01(0.60f, fD), ZM_AnimRotZ(6.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
	...
	void ZM_AvianBuildSpecial(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axSpine01[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-12.0f) },   // puff back
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-14.0f) },   // charged hold
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(6.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axSpine02[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-16.0f) },
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-18.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(8.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_AVIAN_SPINE[2], axSpine02, 5u);
		...
		const ZM_AnimRotKey axHead[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-30.0f) },   // screech up
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-34.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(-6.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_AVIAN_HEAD, axHead, 5u);
		...
		const ZM_AnimRotKey axWingL[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotZ(55.0f) },    // spread out
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotZ(60.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotZ(20.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_AVIAN_WING[0], axWingL, 5u);
		const ZM_AnimRotKey axWingR[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotZ(-55.0f) },
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotZ(-60.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotZ(-20.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axTail[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.35f, fD), ZM_AnimRotX(-14.0f) },   // fan up
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(-16.0f) },
			{ ZM_AnimTimeForT01(0.78f, fD), ZM_AnimRotX(-4.0f)  },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
	...
	void ZM_AvianBuildHit(Flux_AnimationClip& xOut)
	{
		...
		const ZM_AnimRotKey axSpine01[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.25f, fD), ZM_AnimRotX(-12.0f) },   // recoil back
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(5.0f)   },   // overshoot settle
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axSpine02[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.25f, fD), ZM_AnimRotX(-14.0f) },
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(6.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axHead[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.25f, fD), ZM_AnimRotCompose(ZM_AnimRotX(-18.0f), ZM_AnimRotZ(7.0f)) },   // snap
			{ ZM_AnimTimeForT01(0.55f, fD), ZM_AnimRotX(4.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		...
		const ZM_AnimRotKey axWingL[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.28f, fD), ZM_AnimRotZ(25.0f) },    // flinch out
			{ ZM_AnimTimeForT01(0.60f, fD), ZM_AnimRotZ(-6.0f) },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_AVIAN_WING[0], axWingL, 4u);
		const ZM_AnimRotKey axWingR[] = {
			{ ZM_AnimTimeForT01(0.00f, fD), xId },
			{ ZM_AnimTimeForT01(0.28f, fD), ZM_AnimRotZ(-25.0f) },
			{ ZM_AnimTimeForT01(0.60f, fD), ZM_AnimRotZ(6.0f)   },
			{ ZM_AnimTimeForT01(1.00f, fD), xId },
		};
		ZM_AnimAddRotKeys(xOut, szZM_AVIAN_WING[1], axWingR, 4u);
