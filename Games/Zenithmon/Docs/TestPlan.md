...
★ **SUPERSEDED -- the CURRENT baseline is ZM 2969, engine 1344**, registry unmoved
at **55**. OBSERVED 2026-08-06 on clean `Null_` builds:
`2969 ran, 2967 passed, 0 failed, 2 skipped`. Derivation: ZM-D-183 added the two
...
1340 -> **1344**), taking ZM to **2969**. `zm-tests.yml` `-Baseline` and
