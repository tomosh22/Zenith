...
★ **SUPERSEDED -- the CURRENT baseline is ZM 2965, engine 1340**, registry unmoved
at **55**. OBSERVED 2026-08-06 on clean `Null_` builds:
`2965 ran, 2963 passed, 0 failed, 2 skipped`. Derivation: ZM-D-183 added the two
...
units added 3 more ENGINE units (engine 1337 -> **1340**), taking ZM to **2965**.
`zm-tests.yml` `-Baseline` and `run_unit_gate.ps1`'s default both moved to match. The paragraph below is the
