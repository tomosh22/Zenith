...
- **★ THE LIVE BASELINE IS IN `Status.md`'s TOP BLOCK. READ IT, NOT THIS PARAGRAPH.** As of
  ...
  **2947 ran / 2945 passed / 0 failed / 2 skipped**, engine boot **1322**. (+20 engine
  units for the GPU-grass overhaul Phase-1 `FluxGrassTypes` suite in
  `Zenith/Flux/Vegetation/Flux_Grass.Tests.inl`, then +2 for its Phase-2
  `FluxBufferReadback` zero-fill-contract units.) (The pre-grass 2026-08-06 figures were
