...
{
	static void Write(Zenith_DataStream& xStream, const TilePuzzleLevelData& xLevel)
	{
		// Header
	...
	static bool Read(Zenith_DataStream& xStream, TilePuzzleLevelData& xLevel, std::vector<TilePuzzleShapeDefinition>& axShapeDefsOut)
	{
